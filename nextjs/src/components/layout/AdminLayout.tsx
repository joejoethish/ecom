...
const navigation = [
  { name: 'Dashboard', href: ADMIN_ROUTES.DASHBOARD, icon: Home },
  { name: 'Analytics', href: ADMIN_ROUTES.ANALYTICS, icon: BarChart3 },
  { name: 'Orders', href: ADMIN_ROUTES.ORDERS, icon: ShoppingCart },
  { name: 'Products', href: ADMIN_ROUTES.PRODUCTS, icon: Package },
  { name: 'Customers', href: ADMIN_ROUTES.CUSTOMERS, icon: Users },
  { name: 'Content', href: ADMIN_ROUTES.CONTENT, icon: Image },
  { name: 'Reports', href: ADMIN_ROUTES.REPORTS, icon: FileText },
  { name: 'System Health', href: ADMIN_ROUTES.SYSTEM, icon: Activity },
  { name: 'Notifications', href: ADMIN_ROUTES.NOTIFICATIONS, icon: Bell },
