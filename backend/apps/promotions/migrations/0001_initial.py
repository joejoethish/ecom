    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "buy_quantity",
                    models.PositiveIntegerField(default=1, help_text="Buy X items"),
                ),
                (
                    "get_quantity",
                    models.PositiveIntegerField(default=1, help_text="Get Y items"),
                ),
                (
                ...
                (
                    "priority",
                    models.PositiveIntegerField(
                        default=1, help_text="Higher numbers have higher priority"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "template_data",
                    models.JSONField(help_text="JSON configuration for the promotion"),
                ),
                ("usage_count", models.PositiveIntegerField(default=0)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="promotions__promoti_542070_idx",
                    ),
                    models.Index(
                        fields=["used_at"], name="promotions__used_at_e46e34_idx"
                    ),
                    models.Index(
                        fields=["is_suspicious"], name="promotions__is_susp_5a1e23_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["scheduled_time", "is_executed"],
                        name="promotions__schedul_56ba97_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_included",
                    models.BooleanField(
                        default=True, help_text="True for included, False for excluded"
                    ),
                ),
                (
                    "product",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["promotion", "timestamp"],
                        name="promotions__promoti_6aba4f_idx",
                    ),
                    models.Index(
                        fields=["user", "timestamp"],
                        name="promotions__user_id_e9a13b_idx",
                    ),
                    models.Index(
                        fields=["action"], name="promotions__action_91eede_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["date"], name="promotions__date_f981bc_idx"),
                    models.Index(
                        fields=["promotion", "date"],
                        name="promotions__promoti_fe5a78_idx",
                    ),
                ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="promotions__status_01e07b_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="promotion",
            index=models.Index(
                fields=["promotion_type"], name="promotions__promoti_f59ec4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="promotion",
            index=models.Index(
                fields=["target_type"], name="promotions__target__dcc3d0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="promotion",
            index=models.Index(
                fields=["priority"], name="promotions__priorit_5260ee_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="promotion",
            index=models.Index(
                fields=["created_at"], name="promotions__created_dcd10a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="coupon",
        ...
        migrations.AddIndex(
            model_name="coupon",
            index=models.Index(
                fields=["is_active"], name="promotions__is_acti_8daf39_idx"
            ),
        ),
    ]
