    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True, verbose_name="Newsletter Subscription"
                    ),
                ),
                (
                    "sms_notifications",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_public",
                    models.BooleanField(default=False, verbose_name="Public Wishlist"),
                ),
                (
                    "customer",
                    models.OneToOneField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="customers_w_wishlis_6b7717_idx",
                    ),
                    models.Index(
                        fields=["product"], name="customers_w_product_6f8cc9_idx"
                    ),
                ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["account_status"], name="customers_c_account_0c88f5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customerprofile",
            index=models.Index(
                fields=["is_verified"], name="customers_c_is_veri_834234_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customerprofile",
            index=models.Index(
                fields=["total_orders"], name="customers_c_total_o_8ff80c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customerprofile",
            index=models.Index(
                fields=["total_spent"], name="customers_c_total_s_0cb95f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customerprofile",
            index=models.Index(
                fields=["last_login_date"], name="customers_c_last_lo_5154b2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="customeractivity",
            index=models.Index(
                fields=["customer", "activity_type"],
                name="customers_c_custome_becf78_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="customeractivity",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="customers_c_activit_d2cce7_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="address",
        ...
        migrations.AddIndex(
            model_name="address",
            index=models.Index(
                fields=["customer", "type"], name="customers_a_custome_b6ecf1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="address",
            index=models.Index(
                fields=["postal_code"], name="customers_a_postal__89520f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="address",
            index=models.Index(
                fields=["city", "state"], name="customers_a_city_ed6507_idx"
            ),
        ),
