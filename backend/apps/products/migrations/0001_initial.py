    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["average_rating"], name="products_pr_average_13a809_idx"
                    ),
                    models.Index(
                        fields=["total_reviews"], name="products_pr_total_r_73f064_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["brand", "is_active"], name="products_pr_brand_db7730_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="category",
