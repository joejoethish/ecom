...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="system_settings.settingcategory",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="environment_syncs",
                        to="system_settings.systemsetting",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="approved_setting_changes",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="systemsetting",
            index=models.Index(
                fields=["category", "is_active"], name="system_sett_categor_357a78_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="systemsetting",
            index=models.Index(
                fields=["environment"], name="system_sett_environ_616dcb_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["setting", "-changed_at"], name="system_sett_setting_cd1384_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="settingchangehistory",
            index=models.Index(
                ...
                name="system_sett_changed_e1fb20_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="settingauditlog",
            index=models.Index(
                fields=["setting", "-timestamp"], name="system_sett_setting_07d306_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="settingauditlog",
            index=models.Index(
                fields=["user", "-timestamp"], name="system_sett_user_id_c99dd4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="settingauditlog",
            index=models.Index(
                fields=["action", "-timestamp"], name="system_sett_action_6d1b3b_idx"
            ),
        ),
    ]
